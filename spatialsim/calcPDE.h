...
//void reversePolishRK(reactionInfo *rInfo, GeometryInfo *geoi, Model *model, std::vector<variableInfo*> &varInfoList, int Xindex, int Yindex, int Zindex, double dt, int m);
